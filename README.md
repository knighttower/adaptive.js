...
- Adaptive: Main Adaptive.js 
 - Observer: Easy register or unregister callback functions to be executed when any document node changes
 - Teleport: teleport elements to other locations
 - ElementHelper: Element selector with some utility functions and Xpath support
